      ...
      <table class="table table-striped">
        <thead>
          <tr>
            ...
            <th>管理</th>
            <th><a href="<?=config_item('base_url');?>/index.php/Post_ann/modify/<?=$head->tid?>" class="btn btn-warning">編修</a>　　<a href="<?=config_item('base_url');?>/index.php/Post_ann/deleteAnn/<?=$head->tid?>/<?=$head->partid?>/<?=$body->userid?>" class="btn btn-danger">刪除</a></th>
          </tr>
        </thead>
        <tbody>
        <tr>
