...
<div class="text-center">
    ...
    <a href="<?=config_item('base_url');?>/index.php/Reset/user_request_password/" class="btn btn-primary btn-xm" accesskey="f"><span class="glyphicon glyphicon-question-sign"></span> 忘記密碼</a>
</div>
<?=form_close()?>